...
Partial Public Class Ultimos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        LblUltimosTituloPrincipal.InnerHtml = "Lista de Lo Ultimo | ParaLideres.org"

        ListadodeArticulos = NegBuscar.BuscarArticulosLoUltimo(intInicioPagina, intPaginasporSeccion)
    ...
    Sub listarTabla(ByVal Listado As List(Of InfoArticuloListado))
        ...
        Dim strHtml_Ahref_Inicial As String = "<a href='Ultimos.aspx"
        ...
        Else
            strhtmlinterno = strhtmlinterno & "<a href='Ultimos.aspx?Pag=" & intPaginaActual - 1 & "'> <img src='assets/imgs/widgets/last_updates/left_arrow_off.jpg' onmouseover='assets/imgs/widgets/last_updates/left_arrow_on.jpg' />" & strHtml_Ahref_Final
        End If
        ...
        Else
            ...
            strhtmlinterno = strhtmlinterno & "<a href='Ultimos.aspx?Pag=" & intPaginaActual + 1 & "'> <img src='assets/imgs/widgets/last_updates/right_arrow_off.jpg' onmouseover='assets/imgs/widgets/last_updates/right_arrow_on.jpg' />" & strHtml_Ahref_Final
        End If
