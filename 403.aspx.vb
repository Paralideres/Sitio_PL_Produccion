...
Partial Class _403
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            'oEmail.Asunto = "Ubicacion: " & strUbicacion & "Ambiente : " & _Ambiente & ": Error en Para Lideres, 403"
            'oEmail.Contenido = "403.aspx " & strUrl.ToString & vbCrLf & " Direccion IP=" & strIpAddress & vbCrLf & " Path : " & strUbicacion.ToString
            'oEmail.EsHtml = True

            oLog.Descripcion = "Ubicacion: " & strUbicacion & "Ambiente : " & _Ambiente & ": Error en Para Lideres, 403"
            oLog.Error = 403
            oLog.Url = "403.aspx " & strUrl.ToString & vbCrLf & " Direccion IP=" & strIpAddress & vbCrLf & " Path : " & strUbicacion.ToString
