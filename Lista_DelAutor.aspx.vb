...
Partial Public Class Lista_DelAutor
    ...
    Sub listarTabla(ByVal Listado As List(Of InfoLoDelAutor))
        ...
        Dim strHtml_Ahref_Inicial As String = "<a href='Profile.aspx?Id_Autor="
        ...
        Else
            strhtmlinterno = strhtmlinterno & "<a href='Profile.aspx?Id_Autor=" & strParamAutor & "&Pag=" & intPaginaActual - 1 & "'> <img src='assets/imgs/widgets/last_updates/left_arrow_off.jpg' onmouseover='assets/imgs/widgets/last_updates/left_arrow_on.jpg' />" & strHtml_Ahref_Final
        End If
        ...
        Else
            ...
            strhtmlinterno = strhtmlinterno & "<a href='Profile.aspx?Id_Autor=" & strParamAutor & "&Pag=" & intPaginaActual + 1 & "'> <img src='assets/imgs/widgets/last_updates/right_arrow_off.jpg' onmouseover='assets/imgs/widgets/last_updates/right_arrow_on.jpg' />" & strHtml_Ahref_Final
        End If
